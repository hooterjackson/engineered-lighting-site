...
<p class="el-hero__meta"><span>July 2026</span><span>7 documents</span><span>$640–985 end to end</span><span>Current phase · parts ordering</span></p>
...
**Total prototype budget, all hardware:** roughly **$640–985** for one room end-to-end · **Current phase:** parts ordering / bench build
