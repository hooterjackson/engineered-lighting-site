...
<p class="el-hero__meta"><span>July 2026</span><span>8 documents</span><span>$745–1105 end to end</span><span>Current phase · parts ordering</span></p>
...
| 3 | [Build the Gimbal](03-build-the-gimbal.md) | 10-stage bench build: motors answering on CAN by stage 4, a balanced aimed head by stage 8. Full BoM, wiring, code, AI-partner workflow | ~$350–405 |
...
**Total prototype budget, all hardware:** roughly **$745–1105** for one room end-to-end · **Current phase:** parts ordering / bench build
