...
5. Point it at reality: swap the looped clip for the real camera, the simulated fixture for the bench rig — this is [Doc 5 Phase 0](05-teach-it-to-aim.md#phase-0-the-lamp-follows-me-a-weekend-needs-only-the-doc-34-rig-any-rtsp-camera), arrived at with every component already tested. The remaining unknowns are physics, not code.
...
Ultralytics track mode — [docs.ultralytics.com/modes/track](https://docs.ultralytics.com/modes/track) · aioesphomeapi — [github.com/esphome/aioesphomeapi](https://github.com/esphome/aioesphomeapi) · ESPHome host platform — [esphome.io/components/host](https://esphome.io/components/host) · ESPHome external components — [esphome.io/components/external_components](https://esphome.io/components/external_components) + [developers.esphome.io/architecture/components](https://developers.esphome.io/architecture/components) · esphome-canopen (structural reference) — [github.com/mrk-its/esphome-canopen](https://github.com/mrk-its/esphome-canopen) · build-action — [github.com/esphome/build-action](https://github.com/esphome/build-action) · packages/fleet pattern — [esphome.io/components/packages](https://esphome.io/components/packages) + [github.com/jesserockz/esphome-configs](https://github.com/jesserockz/esphome-configs) · mediamtx config (replay) — [mediamtx.org/docs](https://mediamtx.org/docs) · Frigate architecture (process-per-camera precedent) — [docs.frigate.video](https://docs.frigate.video) · hass-client — [github.com/music-assistant/python-hass-client](https://github.com/music-assistant/python-hass-client) · aiomqtt — [pypi.org/project/aiomqtt](https://pypi.org/project/aiomqtt) · uv workspaces — [docs.astral.sh/uv](https://docs.astral.sh/uv) · ESPHome LICENSE (GPL boundary) — [github.com/esphome/esphome/blob/dev/LICENSE](https://github.com/esphome/esphome/blob/dev/LICENSE) · Made for ESPHome — [esphome.io/guides/made_for_esphome](https://esphome.io/guides/made_for_esphome)
