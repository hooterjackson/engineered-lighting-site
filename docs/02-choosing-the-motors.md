...
RMD-L-4005 — [myactuator.com/l-4005-details](https://myactuator.com/l-4005-details) · [dingsmotionusa.com/rmd-l-4005](https://dingsmotionusa.com/rmd-l-4005) · Protocol manual — the file is "Motor Motion Protocol V4.2-250208", inside a bundle confusingly labelled "(L)Protocol and manual of V3" · Osmo Mobile 8 teardown — [chargerlab.com](https://chargerlab.com) · SimpleFOC community (the DIY evidence base) — [community.simplefoc.com](https://community.simplefoc.com) · GoodDog silent gimbal head — gooddog.ai/bumble/gimbal-electronics · SaraKIT quiet pan/tilt — [hackaday.io/project/193511](https://hackaday.io/project/193511) · Caddx GM series + ArduPilot — [ardupilot.org/copter/docs/common-caddx-gimbal.html](https://ardupilot.org/copter/docs/common-caddx-gimbal.html) · Forma MOTOLUX — [formalighting.com](https://formalighting.com)
