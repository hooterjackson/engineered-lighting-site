...
<tr><td><input type="checkbox" class="bom-box" id="d3-printing" data-lo="20" data-hi="20" aria-label='PETG filament + FDM printer access'></td><td><label for="d3-printing">PETG filament + FDM printer access</label></td><td>~250 g</td><td>$20</td><td>Amazon / local makerspace</td><td>Four printed parts plus three test pieces, ~165 g of frame — a makerspace or print service works. See <a href="../03b-print-the-frame/">Doc 3b</a></td></tr>
