...
<tr><td><input type="checkbox" class="bom-box" id="d8-silicone-wire" data-lo="17" data-hi="17" aria-label='Silicone stranded wire, 24 AWG for signals plus 20-22 AWG for zone outputs, and heat-shrink'></td><td><label for="d8-silicone-wire">Silicone <strong>stranded</strong> wire — 24 AWG signals <em>and</em> 20–22 AWG zone outputs — + heat-shrink <span class="bom-optional">if not owned</span></label></td><td>—</td><td>~$17</td><td>Amazon</td><td>Stranded is right here: it's all soldered, and the service loops across the pan/tilt joints want the floppiest wire available. Silicone insulation is worth paying for at 100+ joints — it won't shrink back and bare a neighbour when the iron brushes it. Get <strong>two gauges</strong>: 24 AWG is signals only, 20–22 AWG for anything carrying tape current</td></tr>
