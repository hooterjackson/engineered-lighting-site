...
<tr><td><input type="checkbox" class="bom-box" id="d3-bearing" data-lo="8" data-hi="10" aria-label='608ZZ bearing, 8 × 22 × 7 mm ("skateboard bearing")'></td><td><label for="d3-bearing">608ZZ bearing, 8 × 22 × 7 mm (a skateboard bearing)</label></td><td>1 (buy the 10-pack)</td><td>$8–10</td><td>Amazon, any skate shop</td><td>The <strong>only</strong> bearing in the machine. Carries the idle end of the tilt axis: it presses into the printed <code>bearing_carrier</code> and the printed trunnion stub turns inside it. 608 <strong>ZZ</strong> (metal shields) or 2RS (rubber) both work; ABEC rating is irrelevant here</td></tr>
