...
| # | Doc (file) | What it is | You buy |
|---|---|---|---|
| 1 | **How We Got Here** (this file) | Round-1 research digest: the physics, vocabulary, and five lessons under every later decision. Archive — read for understanding | nothing |
| 2 | **Choosing the Motors** (`robotic-spotlight-micro-gimbal-research.md`) | The decision journey to the RMD-L-4005 smart CAN actuators — what was evaluated, why integrated actuators won | (decision feeds Doc 3) |
| 3 | **Build the Gimbal** (`gimbal-breadboard-prototype-plan.md`) | 10-stage bench build: motors answering on CAN by stage 4, a balanced aimed head by stage 8. Full BoM, wiring, code, AI-partner workflow | ~$185–290 |
| 4 | **Build the Full Fixture Bench** (`combined-bench-prototype-plan.md`) | One ESP32-C6 running the whole fixture: 21 tunable-white channels + CC spotlight + gimbal, in ESPHome/Home Assistant | ~$170–240 |
| 5 | **Teach It to Aim** (`spatial-intelligence-architecture.md`) | The perception stack: cameras, ground-plane tracking, beam self-calibration, coordination, safety, user stories, phased roadmap (Phase 0 = a weekend) | ~$120–320 per room |
